...
r_biceps_torque_muscle_1_all_temp = [];
r_triceps_torque_muscle_1_all_temp = [];
r_a_delt_torque_muscle_1_all_temp = [];
r_p_delt_torque_muscle_1_all_temp = [];
r_biceps_torque_muscle_2_all = [];
r_triceps_torque_muscle_2_all = [];
r_a_delt_torque_muscle_2_all = [];
r_p_delt_torque_muscle_2_all = [];
r_biceps_torque_muscle_2_all_temp = [];
r_triceps_torque_muscle_2_all_temp = [];
r_a_delt_torque_muscle_2_all_temp = [];
r_p_delt_torque_muscle_2_all_temp = [];
...
for i = 1:nIteration
    ...
    for j = 1:5
        [r_biceps_torque_muscle_1,lags] = xcorr(EMG_biceps(j,:)-mean(EMG_biceps(j,:)),torque_1_muscle(j,:)-mean(torque_1_muscle(j,:)),window_size,'coeff');
        r_biceps_torque_muscle_1_all_temp = [r_biceps_torque_muscle_1_all_temp;r_biceps_torque_muscle_1];
        [r_triceps_torque_muscle_1,~] = xcorr(EMG_triceps(j,:)-mean(EMG_triceps(j,:)),torque_1_muscle(j,:)-mean(torque_1_muscle(j,:)),window_size,'coeff');
        r_triceps_torque_muscle_1_all_temp = [r_triceps_torque_muscle_1_all_temp;r_triceps_torque_muscle_1];   
        [r_a_delt_torque_muscle_1,~] = xcorr(EMG_a_delt(j,:)-mean(EMG_a_delt(j,:)),torque_1_muscle(j,:)-mean(torque_1_muscle(j,:)),window_size,'coeff');
        r_a_delt_torque_muscle_1_all_temp = [r_a_delt_torque_muscle_1_all_temp;r_a_delt_torque_muscle_1];
        [r_p_delt_torque_muscle_1,~] = xcorr(EMG_p_delt(j,:)-mean(EMG_p_delt(j,:)),torque_1_muscle(j,:)-mean(torque_1_muscle(j,:)),window_size,'coeff');
        r_p_delt_torque_muscle_1_all_temp = [r_p_delt_torque_muscle_1_all_temp;r_p_delt_torque_muscle_1];
        
        [r_biceps_torque_muscle_2,~] = xcorr(EMG_biceps(j,:)-mean(EMG_biceps(j,:)),torque_2_muscle(j,:)-mean(torque_2_muscle(j,:)),window_size,'coeff');
        r_biceps_torque_muscle_2_all_temp = [r_biceps_torque_muscle_2_all_temp;r_biceps_torque_muscle_2];
        [r_triceps_torque_muscle_2,~] = xcorr(EMG_triceps(j,:)-mean(EMG_triceps(j,:)),torque_2_muscle(j,:)-mean(torque_2_muscle(j,:)),window_size,'coeff');
        r_triceps_torque_muscle_2_all_temp = [r_triceps_torque_muscle_2_all_temp;r_triceps_torque_muscle_2];   
        [r_a_delt_torque_muscle_2,~] = xcorr(EMG_a_delt(j,:)-mean(EMG_a_delt(j,:)),torque_2_muscle(j,:)-mean(torque_2_muscle(j,:)),window_size,'coeff');
        r_a_delt_torque_muscle_2_all_temp = [r_a_delt_torque_muscle_2_all_temp;r_a_delt_torque_muscle_2];
        [r_p_delt_torque_muscle_2,~] = xcorr(EMG_p_delt(j,:)-mean(EMG_p_delt(j,:)),torque_2_muscle(j,:)-mean(torque_2_muscle(j,:)),window_size,'coeff');
        r_p_delt_torque_muscle_2_all_temp = [r_p_delt_torque_muscle_2_all_temp;r_p_delt_torque_muscle_2];
    end
    r_biceps_torque_muscle_1_all = [r_biceps_torque_muscle_1_all;mean(r_biceps_torque_muscle_1_all_temp)];
    r_triceps_torque_muscle_1_all = [r_triceps_torque_muscle_1_all;mean(r_triceps_torque_muscle_1_all_temp)];     
    r_a_delt_torque_muscle_1_all = [r_a_delt_torque_muscle_1_all;mean(r_a_delt_torque_muscle_1_all_temp)];
    r_p_delt_torque_muscle_1_all = [r_p_delt_torque_muscle_1_all;mean(r_p_delt_torque_muscle_1_all_temp)];
    ...
    r_biceps_torque_muscle_2_all = [r_biceps_torque_muscle_2_all;mean(r_biceps_torque_muscle_2_all_temp)];
    r_triceps_torque_muscle_2_all = [r_triceps_torque_muscle_2_all;mean(r_triceps_torque_muscle_2_all_temp)];     
    r_a_delt_torque_muscle_2_all = [r_a_delt_torque_muscle_2_all;mean(r_a_delt_torque_muscle_2_all_temp)];
    r_p_delt_torque_muscle_2_all = [r_p_delt_torque_muscle_2_all;mean(r_p_delt_torque_muscle_2_all_temp)];
...
r_biceps_torque_muscle_1_rand_all_temp = [];
r_triceps_torque_muscle_1_rand_all_temp = [];
r_a_delt_torque_muscle_1_rand_all_temp = [];
r_p_delt_torque_muscle_1_rand_all_temp = [];
r_biceps_torque_muscle_2_rand_all_temp = [];
r_triceps_torque_muscle_2_rand_all_temp = [];
r_a_delt_torque_muscle_2_rand_all_temp = [];
r_p_delt_torque_muscle_2_rand_all_temp = [];
...
for i = 1:nIteration
    ...
    for j = 1:5
        [r_biceps_torque_muscle_1_rand,lags] = xcorr(EMG_biceps(j,:)-mean(EMG_biceps(j,:)),torque_1_muscle(j,:)-mean(torque_1_muscle(j,:)),window_size,'coeff');
        r_biceps_torque_muscle_1_rand_all_temp = [r_biceps_torque_muscle_1_rand_all_temp;r_biceps_torque_muscle_1_rand];
        [r_triceps_torque_muscle_1_rand,~] = xcorr(EMG_triceps(j,:)-mean(EMG_triceps(j,:)),torque_1_muscle(j,:)-mean(torque_1_muscle(j,:)),window_size,'coeff');
        r_triceps_torque_muscle_1_rand_all_temp = [r_triceps_torque_muscle_1_rand_all_temp;r_triceps_torque_muscle_1_rand];   
        [r_a_delt_torque_muscle_1_rand,~] = xcorr(EMG_a_delt(j,:)-mean(EMG_a_delt(j,:)),torque_1_muscle(j,:)-mean(torque_1_muscle(j,:)),window_size,'coeff');
        r_a_delt_torque_muscle_1_rand_all_temp = [r_a_delt_torque_muscle_1_rand_all_temp;r_a_delt_torque_muscle_1_rand];
        [r_p_delt_torque_muscle_1_rand,~] = xcorr(EMG_p_delt(j,:)-mean(EMG_p_delt(j,:)),torque_1_muscle(j,:)-mean(torque_1_muscle(j,:)),window_size,'coeff');
        r_p_delt_torque_muscle_1_rand_all_temp = [r_p_delt_torque_muscle_1_rand_all_temp;r_p_delt_torque_muscle_1_rand];
        
        [r_biceps_torque_muscle_2_rand,~] = xcorr(EMG_biceps(j,:)-mean(EMG_biceps(j,:)),torque_2_muscle(j,:)-mean(torque_2_muscle(j,:)),window_size,'coeff');
        r_biceps_torque_muscle_2_rand_all_temp = [r_biceps_torque_muscle_2_rand_all_temp;r_biceps_torque_muscle_2_rand];
        [r_triceps_torque_muscle_2_rand,~] = xcorr(EMG_triceps(j,:)-mean(EMG_triceps(j,:)),torque_2_muscle(j,:)-mean(torque_2_muscle(j,:)),window_size,'coeff');
        r_triceps_torque_muscle_2_rand_all_temp = [r_triceps_torque_muscle_2_rand_all_temp;r_triceps_torque_muscle_2_rand];   
        [r_a_delt_torque_muscle_2_rand,~] = xcorr(EMG_a_delt(j,:)-mean(EMG_a_delt(j,:)),torque_2_muscle(j,:)-mean(torque_2_muscle(j,:)),window_size,'coeff');
        r_a_delt_torque_muscle_2_rand_all_temp = [r_a_delt_torque_muscle_2_rand_all_temp;r_a_delt_torque_muscle_2_rand];
        [r_p_delt_torque_muscle_2_rand,~] = xcorr(EMG_p_delt(j,:)-mean(EMG_p_delt(j,:)),torque_2_muscle(j,:)-mean(torque_2_muscle(j,:)),window_size,'coeff');
        r_p_delt_torque_muscle_2_rand_all_temp = [r_p_delt_torque_muscle_2_rand_all_temp;r_p_delt_torque_muscle_2_rand];
    end
    r_biceps_torque_muscle_1_rand_all = [r_biceps_torque_muscle_1_rand_all;mean(r_biceps_torque_muscle_1_rand_all_temp)];
    r_triceps_torque_muscle_1_rand_all = [r_triceps_torque_muscle_1_rand_all;mean(r_triceps_torque_muscle_1_rand_all_temp)];     
    r_a_delt_torque_muscle_1_rand_all = [r_a_delt_torque_muscle_1_rand_all;mean(r_a_delt_torque_muscle_1_rand_all_temp)];
    r_p_delt_torque_muscle_1_rand_all = [r_p_delt_torque_muscle_1_rand_all;mean(r_p_delt_torque_muscle_1_rand_all_temp)];
    ...
    r_biceps_torque_muscle_2_rand_all = [r_biceps_torque_muscle_2_rand_all;mean(r_biceps_torque_muscle_2_rand_all_temp)];
    r_triceps_torque_muscle_2_rand_all = [r_triceps_torque_muscle_2_rand_all;mean(r_triceps_torque_muscle_2_rand_all_temp)];     
    r_a_delt_torque_muscle_2_rand_all = [r_a_delt_torque_muscle_2_rand_all;mean(r_a_delt_torque_muscle_2_rand_all_temp)];
    r_p_delt_torque_muscle_2_rand_all = [r_p_delt_torque_muscle_2_rand_all;mean(r_p_delt_torque_muscle_2_rand_all_temp)];
...
hold on
plot(lags,mean(r_triceps_torque_muscle_1_all),'LineWidth',2,'color',[204,45,53]/255)
...
hold on
plot(lags,mean(r_triceps_torque_muscle_2_all),'LineWidth',2,'color',[204,45,53]/255)
