...
for k = 1:size(r_triceps_torque_muscle_1,2)
    [~,p(k)] = ttest(r_triceps_torque_muscle_1_all_fz(:,k)); %,r_triceps_torque_muscle_1_rand_all_fz(:,k),'Vartype','unequal');
end
...
for k = 1:size(r_a_delt_torque_muscle_1,2)
    [~,p(k)] = ttest(r_a_delt_torque_muscle_1_all_fz(:,k));%,r_a_delt_torque_muscle_1_rand_all_fz(:,k),'Vartype','unequal');
end
...
for k = 1:size(r_biceps_torque_muscle_2,2)
    [~,p(k)] = ttest(r_biceps_torque_muscle_2_all_fz(:,k)); %,r_biceps_torque_muscle_2_rand_all_fz(:,k),'Vartype','unequal');
end
...
for k = 1:size(r_triceps_torque_muscle_2,2)
    [~,p(k)] = ttest(r_triceps_torque_muscle_2_all_fz(:,k)); %,r_triceps_torque_muscle_2_rand_all_fz(:,k),'Vartype','unequal');
end
