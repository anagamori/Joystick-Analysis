...
index_identified = [];
theta = 0:0.01:2*pi;
for j = 1:8 %size(index_validTrial,2) %1:50 %3:32
    
    filename_cam1 = listing(3*(j-1)+12).name; %'M_012121_CT_102121_v2_4_17-04-00_cam1DLC_resnet_50_JoystickOct23shuffle1_50000';
